    ...
    <div class="container" style="margin-top: 100px;margin-bottom:100px">
        <div class="card shadow border-0">
            <div class="card-body">
                ...
                <form action="/my-account/update" method="post" class="mb-5" enctype="multipart/form-data">
                    @csrf
                    {{-- @method('put') --}}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control  @error('no_wa') is-invalid @enderror" id="no_wa"
                            value="{{ old('no_wa', $user->no_wa) }}"name="no_wa">
                        @error('no_wa')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control  @error('tgl_lhr') is-invalid @enderror" id="tgl_lhr"
                            value="{{ old('tgl_lhr', $user->tgl_lhr) }}"name="tgl_lhr">
                        @error('tgl_lhr')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control  @error('code_pos') is-invalid @enderror" id="code_pos"
                            value="{{ old('code_pos', $user->code_pos) }} " name="code_pos">
                        @error('code_pos')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
