<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #4C585B;">
    <div class="container">
...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark" style="background-color: #4C585B;">
    ...
    <nav class="navbar fixed-top mt-5 navbar-expand-lg navbar-dark" style="background-color: #9AA6B2;">
    <div class="container-lg">
            <a class="navbar-brand fs-1" style="font-family:Brush Script MT;" href="/">Den<span
            ...
            <div class="offcanvas text-bg-dark offcanvas-end w-50" tabindex="-1" id="offcanvasnavbar"
                ...
                <div class="offcanvas-header">
                    <a class="offcanvas-title text-light text-decoration-none fs-1" style="font-family:Brush Script MT;"
                        href="/" id="offcanvaslabel">Denshop<span style="font-family:Brush Script MT;"
                            class="fs-2">Shop
                        </span></a>
