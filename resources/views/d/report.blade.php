...
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom"><h2>Report 2024</h2>
            ...
            <div class="col-xl-8 col-lg-7">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                      ...
                      <h6 class="m-0 font-weight-bold text-primary">Grafik penjualan bulanan tahun 2024</h6>
